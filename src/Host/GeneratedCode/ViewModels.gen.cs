...
namespace Primavera.Lithium.ChatGPT.Server.Host.ViewModels;
...
public partial class ErrorViewModel : ErrorViewModelBase
{
    ...
    /// </returns>
    public static string GetPageTitle(ErrorViewModel model, Common.Configuration.HostConfiguration hostConfiguration)
    {
    ...
    public static void GetTitle(ErrorViewModel? model, out string title)
    {
        if (model == null)
        {
